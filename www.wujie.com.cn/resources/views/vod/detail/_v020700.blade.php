    ...
    <section class="containerBox none" >
        ...
        <!-- 基本信息 -->
            <div class="mb10 basic_info ">   
                <!-- 2.7新增分销赚佣 -->
                <div class="distribution white-bg none mb1-5 mt7-133 none" id="distribution">
                    <p class="fline pl1-33">
                    ...
                    <div class="clearfix"></div>
                    <div class="tc pb1-5 more_icon pl1-33" ><img src="{{URL::asset('/')}}/images/more_icon.png" alt="" style="width:1.33rem;"></div>
                </div>
                <div>
                <!-- 品牌信息 -->
...
@section('endjs')
    ...
    <script type="text/javascript" src="{{URL::asset('/')}}/js/_v020700/vod.js"></script>
