    ...
    <script type="text/javascript">
      ...
      Zepto(function(){
        ...
        function getBanner(type){
          var url = labUser.agent_path +'/ad/list/_v010005';
              ...
              if(data.status){
                ...
                var mySwiper = new Swiper('#swiper-container',{//子swiper 
                        ...
                        onInit: function(swiper){
                          var splide = $('.swiper-wrapper .swiper-slide');
                                if(splide.length == 1 || splide.length == 0){
        ...
        //获取分类
        function getType(){
          var url=labUser.agent_path +'/lessons/types/_v010005';
        ...
        function videoList(page,pageSize,type,click_type){
             var param = {};
                 ...
                 param.type = type;
             var url=labUser.agent_path +'/lessons/list/_v010005';
             ajaxRequest(param,url,function(data){
                if(data.status){
                  var vodHtml = '';
                  if(data.message){
                    $.each(data.message,function(i,j){
                      vodHtml +='<li class="A_videos_intro l" data-id="'+j.id+'"><div class="A_videos_img mb05 relative"><img style="height:100%"   class="lazy" data-original="'+j.image+'"><p class="f11 white views mb0"><img src="/images/agent/views.png" style="width:1.2rem;height1.2rem;margin-right:0.5rem;">浏览量 '+Format(j.view)+'</p>';
                      vodHtml +='</div><div><p class="f13 color333 ui-nowrap-multi height4">'+j.subject+'</p>';
                      vodHtml +=' </div></li> '
                    });
      ...
      //格式化浏览量
        ...
        $(document).on('click','.A_videos_intro',function(){
          ...
          onAgentEvent('video_class','',{'type':'video_class','id':id,'userId':agent_id,'position':'3'});
