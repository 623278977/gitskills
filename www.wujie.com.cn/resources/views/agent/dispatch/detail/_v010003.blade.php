      ...
      <!-- 头部 -->
        ...
        <div class="bgwhite pl1-5 pr1-5 pt1 mb1"> 
            <div class="pb05">
                ...
                <p ><span class="red-point mr1 ver-middle"></span><span class="color666 f13 commission"></span><span class="f11 ml1 color999">最高佣金提成</span></p>
    ...
    <script type="text/javascript">
      ...
      Zepto(function(){
        ...
        var agent_id = args['agent_id'] || 0,
            id = args['id'];
        var url = labUser.agent_path+'/consult/detail/_v010003'
          ajaxRequest({"agent_id":agent_id,"id":id},url,function(data){
              if(data.status){
                ...
                $('.commission').text(mes.commission+'元');
