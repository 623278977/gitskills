...
@section('css')
    ...
    <link href="{{URL::asset('/')}}/css/v010000/investask.css" rel="stylesheet" type="text/css"/>
@stop
@section('main')
    <section id="act_container" class="none">
       ...
       <div class="ui_container_wait">
             ...
             <section class="ui_invite_container" style="height:27rem">
               <div class="ui_infor">
...
@stop
@section('endjs')
    <script type="text/javascript" src="{{URL::asset('/')}}/js/agent/investask.js"></script>
@stop