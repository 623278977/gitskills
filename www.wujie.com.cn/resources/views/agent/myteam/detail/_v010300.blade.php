       ...
       Zepto(function(){
        ...
        // 下线经纪人
            function getDownliner(id){
              var url =labUser.agent_path + '/user/subordinate/_v010300';
      ...
      //跳转经纪人详情
          ...
          // 团队业绩
            function getTeamClan(id){
              var url = labUser.agent_path + '/user/team-sales/_v010300';
                  ajaxRequest({'agent_id':id},url,function(data){
                      if(data.status){
          ...
          // 团队业绩详情
            function getorderDetail(id,type,page,pageSize){
                var url = labUser.agent_path + '/user/sales-detail/_v010300';
                var param = {};
                    param['agent_id'] = id;
                    param['type'] = type;
                    param['page'] = page;
