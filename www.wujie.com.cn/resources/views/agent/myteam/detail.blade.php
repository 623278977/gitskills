...
@section('main')
    <section class="containerBox none bgcolor" id="containerBox" style="min-height: 100%">
      <div class="myteamnav">
            <span class="agentBlue " id="downAgent" >下线经纪人</span>
            <span id="" >团队业绩</span>
      </div>
      <div class="downline">
        <div class="f12 pl1-5 pt1 pb1 color666">成功发展下线<span id="linernum"> </span>人</div>
        ...
        <div>
           <button class="developliners" onclick='devDownline()'>发展下线经纪人</button>
        </div>
      </div>
            ...
            <div class="pl1-5 ">
              <div class="fline pr1-5">
                  <div class="pt2-5 pb2-5 f12 lh2 l w60">
                    ...
                    <p><span class="bluecircle"></span>下线成员 <span id="qua_downorders" class="f15 b"></span></p>
                  </div>
            ...
            <div class="pl1-5 ">
              <div class="fline pr1-5">
                  <div class="pt2-5 pb2-5 f12 lh2 l w60">
                    ...
                    <p><span class="yellowcircle"></span><span class="ownname">我的名字</span> <span id="total_ownorders" class="f15 b"></span></p>
                    <p><span class="bluecircle"></span>下线成员 <span id="total_downorders" class="f15 b"></span></p>
                  </div>
                  <div class="r tr w40 pr1-5">
                    <div class="chart-container r" style="position: relative; height:11rem; width:11rem">
       ...
       Zepto(function(){
        ...
        // 下线经纪人
            function getDownliner(id){
              var url =labUser.agent_path + '/user/subordinate/_v010001';
                      ...
                      if(data.status){
                          ...
                          if(data.message.list.length > 0){
                              $.each(data.message.list,function(i,j){
                                  ...
                                  if(j.gender == 0){
                                      linerHtml += '<p class="gender"><img src="/images/agent/girl.png" alt=""></p></div></div>';
                                  }else if(j.gender == 1){
                                      linerHtml += '<p class="gender"><img src="/images/agent/boy.png" alt=""></p></div></div>';
                                  }else{
                                    linerHtml += '</div></div>';
                                  }       
                              ...
                              $('.downline').addClass('tc').html('<img  src="/images/agent/noteamer.png" style="width:18.5rem;height:14.9rem;margin:auto;margin-top:30%;"><div><button class="developliners" onclick="devDownline()">发展下线经纪人</button></div>'); 
                          } ;
                           mySuperior();
      ...
      //跳转经纪人详情
          ...
          // 团队业绩
            function getTeamClan(id){
              var url = labUser.agent_path + '/user/team-sales/_v010001';
                  ajaxRequest({'agent_id':id},url,function(data){
                      if(data.status){
          ...
          // 团队业绩详情
            function getorderDetail(id,type,page,pageSize){
                var url = labUser.agent_path + '/user/sales-detail/_v010001';
                var param = {};
                    param['agent_id'] = id;
                    param['type'] = type;
                    param['page'] = page;
