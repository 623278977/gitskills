...
<!--zhangx-->
@section('css')
    <link href="{{URL::asset('/')}}/css/agent/_v010002/invitation.css" rel="stylesheet" type="text/css"/>
    <style>
        .spread{ 
            margin: 1.5rem auto;
        }
...
@section('main')
	...
	<section id='container'>
		<!--<div class="personal">
			<img src="/images/agent/inviteCode2.png" alt="" class="company mr1-33 fl"/>
			<div class="xm-amounts xm-detail">
				<p class="mb05 xm-inbs">
					<span class="b f15 color3 ">张长</span>
				</p>
				<p class="mb08 xm-inbs">
					<img src="/images/agent/boy.png" class="gender fl"/>
					<span class="f12 color999">浙江</span>
				</p>
				<p class="">
					<span class="f11 mt05 color333">最后一次登录 :</span>
				</p>
		...
		<div class="personals pb1-5">
				<p class="f15 ptb1-4 b keyword ">
					代理品牌
	...
	<section class="foot_btn">
		<!-- 底部按钮  接单状态-->
		<!--<div class="order_success none">
			<a href=""><img src="/images/agent/sms_03.png" alt=""></a>
		</div>-->
		<!-- 待接单 -->
		<!--<div class="btn ordering none">
			<button class="btn-l f15 re_noreceive">不感兴趣</button>
			<button class="btn-r f15 re_receive">接单</button>
		</div>-->
		<!-- 被接单或拒绝 -->
		<!--<div class="order_fail none">
			<span>已被他人接单或拒绝</span>
		</div>-->
		
	</section>
    <section class="enjoy" style="padding-bottom:10rem;background-color: #f2f2f2;"></section>
@stop
@section('endjs')
