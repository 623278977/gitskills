...
@section('css')
	<link rel="stylesheet" type="text/css" href="{{URL::asset('/')}}/css/agent/_v010003/invitation.css"/>
@stop
<!--zhangxm-->
@section('main')
	<section id='container' class="" style="background:#f2f2f2;">
		<!--<div class="datum bcg-f ">
			<img src="" class="photo"/>
			<div class="datum-l ">
			...
			<div class="defend">
				<span class="f11 ">保护期：</span><span class="f15 bold">22天</span>
			</div>
		</div>
		<div class="relation bcg-f ">
		...
		<!--<div class="masking none">
			<div class="masking-con ">
				<p class="masking-p1 f15  color-f pl-r"><span class="">当前还剩23天保护期</span></p>
	...
	<section>
		<div class="masking_tels none">
			<div class="masking_pop ">
				<p class="masking-p1 f15 color-f pl-r fline"><span class="pop_up bold">提醒</span></p>
		...
		<div class="masking none">
			<div class="invite-succes">
				<p class="masking-p1 f15 color-f pl-r fline"><span class="pop_up bold">提醒</span></p>
				<span class="mt1 mb1 f15 color999">您还没进行实名认证</span>
				<p class="masking-p">
					<span class="stay f12 color999">取消</span>
					<span class="back f12 ">确定</span>
				</p>
			</div>
		</div>
	</section>
...
@section('endjs')
    ...
    <script src="{{URL::asset('/')}}/js/agent/_v010003/invitation.js"></script>
