...
<!--zhangx-->
@section('css')
    <link href="{{URL::asset('/')}}/css/agent/_v010003/agent_detail.css" rel="stylesheet" type="text/css"/>
    <style>
        .spread{ 
            margin: 1.5rem auto;
        }
...
@section('main')
    ...
    <section class="enjoy" style='height:10rem;background-color: #f2f2f2;'></section>
    <section>
...
@section('endjs')
    ...
    <script src="{{URL::asset('/')}}/js/agent/_v010003/agent_detail.js"></script>
	 <script>	
