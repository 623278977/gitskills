...
@section('main')
	...
	<section id='container'>
		...
		<div class="xm-btn none">
			<a href="" class="xm-btn-invest f30 bold">成为投资人</a>
			<a href="" class="xm-btn-agent f30 bold">成为经纪人</a>
		</div>
	</section>
    <section class="enjoy none " style='padding-bottom:10rem;background-color: #f2f2f2;'>
    </section>
...
@section('endjs')
    ...
    <script src="{{URL::asset('/')}}/js/agent/base.js"></script>
	 <script>	
