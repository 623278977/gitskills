	...
	<!-- 团队成长 type=9 -->
		<div class="none">
			...
			<div class="list pb5 pt2 pl1-5 pr1-5">	
				...
				<div class="list-flex">
					<p class="enroll color333">代理1个品牌</p>
					<p class="brand_name color666">
	...
	<!-- 团队发展 type=8-->
		<div class="none">
			...
			<div class="list pb5 pt2 pl1-5 pr1-5">	
				...
				<div class="f11 color999">
					<div>*注册成为无界商圈经纪人，完成实名认证，获得团队发展奖</div>
				</div>
			</div>
		</div>
	<!-- 团队育成奖 -->
		<div class="none">
			...
			<div class="list pb5 pt2 pl1-5 pr1-5">
				<div >
					<p class="f13">达到等级1级，获得团队育成奖2000元</p>
				</div>
				<div class="color666">
	...
	<!-- 发展客户 type=10 -->
		<div class="none">
			...
			<div class="list pb5 pt2 pl1-5 pr1-5">	
				...
				<div class="f11 color999">
					*因邀请有效客户(通过回访及存活时长判定)，给予<em class="getmoney"></em>元奖励
				</div>
			</div>
		</div>
	<!-- 活动邀约奖 -->
	...
	<!-- 到票补贴 -->
		<div class="none">
			<div class="account2 pt2">
				...
				<span class="time">2017/10/22 10:30</span>
				<div class="mt2-1 pb2">
					<p class="p102 commission">+2000</p>
					<p class="p103">*按照实际到账情况计算</p>
				</div>
			</div>
			<div class="list pl1-5 pr1-5 pb5">
				<div class="list-flex">
					...
					<p class="color666">阿树(180000)</p>	
				</div>	
				<div class="list-flex">
					<p class="enroll color333">考察品牌</p>
					<p class="enrollTime color666">洗茶</p>	
				</div>
				<div class="list-flex">
					<p class="enroll color333">考察门店</p>
					<div class="color666 tr">
						<p class="color666">洗茶</p>
						<p class="color666">所在地区</p>	
						<p class="color666">详细地址</p>		
					</div>
				</div>
				<div class="list-flex">
					<p class="enroll color333">考察订金</p>
					<p class="enrollTime color666">洗茶</p>	
				</div>
				<div class="list-flex">
					<p class="enroll color333">交付情况</p>
					<p class="enrollTime color666">洗茶</p>	
				</div>
				<div class="list-flex">
					<p class="enroll color333">考察时间</p>
					<p class="enrollTime color666">洗茶</p>	
				</div>
				<div class="list-flex">
					<p class="enroll color333">品牌商务对接</p>
					<p class="enrollTime color666">程里(18000000000)</p>	
				</div>
		...
		Zepto(function(){
			 var args = getQueryStringArgs();
          	...
          	function  getDetail(id,type,log_id){
          		var url = labUser.agent_path +'/user/commission-detail/_v010002';
