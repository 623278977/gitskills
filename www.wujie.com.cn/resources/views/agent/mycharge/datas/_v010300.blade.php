...
@section('main')
	<section class="containerBox bgcolor " style="min-height: 100%;" id="containerBox" >
		...
		<div class="none">
			...
			<div class="list pl1-5 pr1-5 pb2">
				...
				<p>
					<span>加盟类型：</span>
					<span class="jm-type" style="float: right;color: #666666;"></span>
				</p>
				<p class="relative mb1-5">
					<span>总费用：</span>
					<span class="money" style="float: right;color: #666666;"></span>
					<span  style="position: absolute;right: 0;color: #999;font-size: 1rem;bottom: -1.5rem;">*佣金可提成部分为￥<em class="reward-money"></em>元</span>
				</p>
				<p>
					<span>费用结清日期：</span>
					<span class="finish-time" style="float: right;color: #666666;"></span>
				</p>
				<p>
					<span>成单经纪人：</span>
			...
			<div class="list pb5 pt2 pl1-5 pr1-5">
				...
				<div class="color666">
					<table class="color333 f11 teamtable">
						...
						<tr>
							<td class="tc" style="vertical-align: middle;">1(三星主管)</td>
							<td>1、团队成员人数达5人（是指直接下级） 2、团队累计完成1单</td>
							<td class="tc" style="vertical-align: middle;">2,000元</td>
						</tr>
						<tr>
							<td class="tc" style="vertical-align: middle;">2(四星主管)</td>
							<td>1、团队成员人数达15人 2、团队累计完成3单 3、至少1名团队成员为三星主管</td>
							<td class="tc" style="vertical-align: middle;">4,000元</td>
						</tr>
						<tr>
							<td class="tc" style="vertical-align: middle;">3(五星主管)</td>
							<td>1、团队成员人数达30人 2、团队累计完成6单 3、至少2名团队成员为三星主管</td>
							<td class="tc" style="vertical-align: middle;">6,000元</td>
						</tr>
					</table>
				</div>
	...
	<!-- 活动邀约单次活动 type=14-->
		<div class="none">
			...
			<div class="list pl1-5 pr1-5">
				...
				<div class="list-flex">
					<p>签到会场</p>
					<p class="color666 tr ovo_name"></p>
				</div>
				<div class="list-flex">
					<p >签到投资人</p>
					<p class="color666 tr sign_name"></p>				
				</div>
				<div class="list-flex">
					<p >签到时间</p>
					<p class="color666 tr sign_time"></p>				
				</div>
				<div class="list-flex">
					<p>奖励金额</p>
					<div class="color666 tr">
				...
				<div class="color666 f12 pt1 pb1">
					(不限邀请方式，邀请注册投资人成功签到即可获得奖励，单个注册投资人账号仅限奖励一次)
				</div>
	...
	<!-- 项目入驻 type=16-->
		...
		<!--朋友圈集赞截屏 type==17-->
		<div class="friends_circle none bgwhite pl1-5 pb2">
			<div class="fline friends_circle_top">
				<p class="f15 color333 mt2 mb05">朋友圈集赞截屏 (元)</p>
				<p class="f12 color999 mb2 check_timehms"></p>
				<p class="f20 color333 mb1-2">+5</p>
				<p class="f12 cffa300 mb2 ">* 按照实际到账情况计算</p>
			</div>
			<p class="f11 color999 mt1-5">*参加无界商圈活动，于<span class="submit_timeYmd"></span>提交朋友圈集赞截屏。</p>
			<p class="f11 color999 mt05">*商圈工作人员于<span class="check_time"></span>通过审核，确定奖励有效。</p>
		</div>
		...
		Zepto(function(){
			 var args = getQueryStringArgs();
          	 ...
          	 if(type == 1){
          	 	...
          	 	divBox.eq(12).removeClass('none');
          	 }
          	function  getDetail(id,type,log_id){
          		var url = labUser.agent_path +'/user/commission-detail/_v010300';
          		ajaxRequest({'id':id,'type':type,'log_id':log_id},url,function(data){
          			if(data.status){
          				...
          				if(type ==1){
							...
							$('.tail-time').text(datas.tail_pay_time);
          					$('.commission').text('+'+datas.commission);					
	          				...
	          				$('.jm-type').text(datas.league_type);//加盟方式
	          				$('.finish-time').text(datas.in_account_time);//费用结清日期
	          				$('.reward-money').text(datas.commission);//佣金可提成
          					...
          					$('.ovo_name').html(datas.maker_name);
          					$('.sign_name').text(datas.username);
          					$('.sign_time').text(datas.sign_time);
          					...
          					$('.check_timehms').text(unix_to_fulltime_hms(data.message.check_at));//审核具体时间
          					$('.submit_timeYmd').text(unix_YMD(data.message.created_time));//提交朋友圈集赞时间
          					$('.check_time').text(unix_YMD(data.message.check_at));//审核时间
