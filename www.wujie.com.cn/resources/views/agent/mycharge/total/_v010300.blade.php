...
@section('main')
    <section class="containerBox pl1-5 pr1-5" id="containerBox" >
        <div>
          ...
          <p class= 'f11 color999 ml1 mb05'>*不包含本月度</p>
        </div>
              ...
              function drawLine(data){
                ...
                for(var i=0; i<len; i++){
                    ...
                    if(yArr[i] == maxY){
                        ...
                        ctx.font=10*n +"px Microsoft Yahei";//2017/10/23调试新增
                        ctx.fillStyle='#ffc599';
                        ctx.fillText(xMemo, x*n , (y-15)*n);
                        ctx.fillStyle='#fff';
                        ctx.fillText(yMemo, (x+10)*n , y*n);
                        console.log(y);
                    };
