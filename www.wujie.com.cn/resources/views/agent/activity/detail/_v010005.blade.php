...
@section('main')
    <section id="act_container" class="none">
       ...
       <!--  底部按钮 -->
        <button class="fixedbottom none">邀请客户报名</button>
        <!--浏览器打开提示-->
        <div class="safari none">
            <img src="{{URL::asset('/')}}/images/safari.png">
        </div>
        <ul class="ui_share">
            <li style="background:#ffa300">报名活动</li>
            <li>邀请客户报名</li>
        </ul>
        <ul class="ui_share " style="display:none">
            <li id="loadapp"><img src="/images/downapp.png"></li>
            <li>立即报名</li>
        </ul>
    </section>
@stop
@section('endjs')
    ...
    <script type="text/javascript" src="{{URL::asset('/')}}/js/agent/_v010005/activity.js"></script>
@stop