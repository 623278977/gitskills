...
<style>
    ...
    #agent_videos li:nth-child(odd){
        float:left;
    }

    #agent_videos li:nth-child(even){
        float:right;
    }
    #swiper-container1{
        overflow: auto;
                    ...
                    <section class="swiper-slide " id='brand_lesson'>
                      <div style="min-height: 101%" id="for_nolesson">
                        ...
                        <div class="mb1-33 white-bg pl1-5 pr1-5">
                            <div class=" color999 pb1-5 pt1-5 f11">
                                <p class="mb05">用户完成线上课程学习，完成线上资讯、视频阅读和观看。品牌客服代表会与您取得联系，并进行相应电话考核。完成考核后，则成功代理该品牌项目，成为品牌代理经纪人。</p>
                            </div> 
                        </div>                   
                                ...
                                <ul id='brand_news'>
                                    <!-- <li class="tl fline mb1-33">
                                        ...
                                        <div class="lh35 color999 mt1">
                                            <span class='l ui-border-t'>未读</span>
                                ...
                                <ul  id='agent_videos'>
                                   <!--  <li class="A_videos_intro l">
                                        ...
                                        <div class="" >
                                            ...
                                            <p class="f11 color666 nowrap mb1">这里的描述控制为但这里的描述控制为但这里的描述控制为但这里的描述控制为但行</p>
                                        </div>
                                    </li>  -->
                                </ul>
                            </div>
...
@section('endjs')
    ...
    <script type="text/javascript" src="{{URL::asset('/')}}/js/agent/_v010002/brand.js"></script>
