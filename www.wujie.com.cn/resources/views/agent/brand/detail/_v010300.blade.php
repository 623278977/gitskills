                    ...
                    <section  class="swiper-slide pb8 " id="swiper-1">
                        ...
                        <div class="brand-head white-bg mb1-5 " >
                            ...
                            <div class="join_type_box fline lh45" style="padding-left: 1.5rem;padding-right: 1.5rem;" id="join_type_box">
                              <!--  <div class="f14 color666 width33_3  l  none" id="dandian">
                                ...
                                <div class="info f12">
                                    ...
                                    <div class="pt1 pb1 pl1-5 pr1-5 flex-bet" >
                                        ...
                                        <div class="tr" style="flex-shrink:0;">
                                            <p class="agent-red f18 mb0 b commission" ></p>
                                            <p class="mb0 f10 color999">佣金最高提成比例</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('endjs')
    ...
    <script type="text/javascript" src="{{URL::asset('/')}}/js/agent/_v010300/brand.js"></script>
