    ...
    <section id="brand_detail" class="bgcolor none">
        ...
        <div id="wrapper">
            <div  id="swiper-container1">
                        ...
                        <div class="brand-info white-bg mb1-5   ">
                            <div class="">
                                <div class="info f12">
                                    ...
                                    <div class="pt1 pb1 pl1-5 pr1-5" style='overflow: hidden;'>
                                        <div class="l lh45 keywords" id='keywords'>
                                        </div>
                                        <div class="r tr">
                        ...
                        <div class="mb1-33 white-bg pl1-5 nocustomer">
                            ...
                            <div class="pr1-5 pb1-5" id='suc_customer'>
                                <!-- <div class="bgf5 mb1-33 is_show_suc">
                                    <div class="customer_flex p1 dashline">
                                        <div>
                                            <img src="" alt="header" class="l mr1 customer_img">
                                             <div class="l">  
                                                <p class="f15 mb05"><span>华容</span><img src="/images/agent/girl.png" alt="性别" class="gender"></p>
                                    ...
                                    <ul class="followlists">
                                        ...
                                        <li>
                                          <p class="color999">
                                            <span class="imgbox"><img src="/images/agent/error.png" class="error_img"></span>签约加盟合同，交付线上首付
                                          </p>
                                          <p class="color999 f11">2017/02/02</p>
                                        </li>
                                        <li>
                                          <p class="color999">
                                            <span class="imgbox"><img src="/images/agent/error.png" class="error_img"></span>签约加盟合同，线下尾款补齐
                                          </p>
                                          <p class="color999 f11">2017/02/02</p>
                                        </li>
                                        <li class="see_button mt05">
                                            <button>查看电子合同</button>
                                            <button>查看付款详情</button>
                                            <button>查看提成详情</button>
                                        </li>
                                    </ul>
                
                                </div> -->
                                <!-- <div class="bgf5 mb1-33">
                                    <div class="customer_flex p1 dashline">
                                        <div>
                                            <img src="" alt="header" class="l mr1 customer_img">
                                             <div class="l">  
                                    ...
                                    <div class="c2873ff f12 tc pt1 pb1">收起<span class="showdetail hidedetail"></span></div> 
                                </div> -->
                            </div>     
                        </div>
                       </div> 
                ...
                <!-- 课程 -->
                    <section class="swiper-slide " id='brand_lesson'>
                      <div style="min-height: 101%" id="for_nolesson">
                        <div class="white-bg mb1-33 ">
                            <div class="name_intro fline">
                                <div data-mark="" data-code="" class="f16 lesson_name">
                                     <span class="brand_title b"></span>
                                     <span class="cffa300 ml1 f11" id="already_agent"><img src="/images/agent/lesson.png" alt="" class="lesson">学习中</span>
                                </div>
                                 <div class="r mt05">
                                     <p class="color999 mb0 f11">最高提成</p>
                                     <p class="f18 agent-red commission"></p>
                        ...
                        <div class="mb1-33 white-bg pl1-5 pr1-5">
                            <p class="mb1-33 lh45 f16 b fline ">线上视频</p>
                            <div class=" color666 pb1-33 f12">
                                <p class="mb05">1、用户完成线上课程学习，完成线上资讯、视频阅读和观看。</p>
                                <p class="mb05">2、品牌客服代表会与您取得联系，并进行相应电话考核。</p>
                                <p class="mb05">3、完成考核后，则成功代理该品牌项目，成为品牌代理经纪人。</p>
                            </div> 
                        </div>
                        <div class="mb1-33 white-bg pl1-5 pr1-5 agent_videos">
                            <p class="mb1-33 lh45 f16 b fline ">线上视频</p>
                            <div class="f12">
                                <ul  id='agent_videos'>
                                   <!--  <li class="fline mb1-33">
                                        ...
                                        <div class="video_intro" >
                                            ...
                                            <p class="f12 mb0 color999">录制时间：<span>04/09 9：00</span></p>
                                            <div class="f12 video_dis color999">视频描述：<span>这里的描述控制为但这里的描述控制为但这里的描述控制为但这里的描述控制为但行</span></div>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="lh35 color999 mt1">
                                            <span class='l ui-border-t'>已查看</span>
                                            <span class="r">所属权：洗茶</span>
                                        </div>
                                        <div class="clearfix"></div>
                                    </li> -->
                                </ul>
                         ...
                         <div class="mb1-33 white-bg pl1-5 pr1-5  brand_news">
                            <p class="mb1-33 lh45 f16 b fline ">文档</p>
                            <div class="f12">
                                <ul id='brand_news'>
                                   <!--  <li class="tl fline mb1-33">
                                        <p class="f14">下回接电话</p>
                                        <p class="f12 color999">从二十年前，到这之后的几十年，几百年，王小波是一个符号，是中国最后一个孩子气质的文人。</p>
                                        <div class="lh35 color999 mt1">
                                            <span class='l ui-border-t'>唯独</span>
                                            <span class="r">所属权：洗茶</span>
                                        </div>
                                        <div class="clearfix"></div>
                                    </li> -->
...
@section('endjs')
    ...
    <script src="{{URL::asset('/')}}/js/agent/brandDetail.js"></script>
	<script src="{{URL::asset('/')}}/js/agent/src/mTouch.js"></script>
               ...
               $('#swiper-container1').css('height',getWindowHeight());//解决各页面高度不一致
                ...
                //函数内判断，距离底部50px的时候则进行数据加载
                    ...
                    $(document).on('touchend','#brand_detail',function(){
                        ...
                        if(opa > 0.8){
                            mySwiper.slideTo(activeIndex + 1,200,false);
