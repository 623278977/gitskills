...
<!--zhangx-->
@section('css')
    <link href="{{URL::asset('/')}}/css/agent/_v010003/personalshare.css" rel="stylesheet" type="text/css"/>
...
@section('main')
	...
	<section class="section_pop">
		...
		<div class="xm-btn none fixed-bottom-iphoneX">
			<span href="" class="xm-btn-invest f15 ">成为投资人</span>
			<span href="" class="xm-btn-agent f15 ">成为经纪人</span>
		</div>
		<!--自选标题-经纪人-->
		<!--<div class="share-title fixed color666 f14 none share_title_agent">
            <ul id="ul_share_t">
              <li class="share-li tleft lh45 white-bg border-8a-b"><em></em><span class="ul_share_span"></span>邀请你加入无界商圈，成为他的超级事业伙伴！</li>
              <li class="share-li tleft lh45 white-bg border-8a-b"><em></em><span class="ul_share_span"></span>邀请你加入无界商圈，共同打造互联网经纪人时代！</li>
              <li class="share-li tleft lh45 white-bg border-8a-b"><em></em><span class="ul_share_span"></span>邀请你加入无界商圈，成为品牌加盟领航者！</li>
              <li class="share-li tleft lh45 white-bg border-8a-b"><em></em><span class="ul_share_span"></span>邀请你加入无界商圈，挑战佣金无上限！</li>
            </ul>
        </div>-->
        <!--自选标题-投资人-->
        <!--<div class="share-title fixed color666 f14 none share_title_customer">
            <ul id="ul_share_t">
              <li class="share-li tleft lh45 white-bg border-8a-b"><em></em><span class="ul_share_span"></span>邀请你加入无界商圈，成为他的超级事业伙伴！</li>
              <li class="share-li tleft lh45 white-bg border-8a-b"><em></em><span class="ul_share_span"></span>邀请你加入无界商圈，共同打造互联网经纪人时代！</li>
              <li class="share-li tleft lh45 white-bg border-8a-b"><em></em><span class="ul_share_span"></span>邀请你加入无界商圈，成为品牌加盟领航者！</li>
...
@section('endjs')
    ...
    <script src="{{URL::asset('/')}}/js/agent/_v010003/personalshare.js"></script>
	 <script>
