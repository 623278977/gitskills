...
@section('main')
    ...
    <!-- 公用蒙层 -->
        ...
        <div class="ui_container">
            ...
            <div class="ui-iphoneX"></div>
            <div class="ui_top relative addheight addwidth">
              <p class="f15 b ">To无界商圈投资人<span id="customer_name" class="name f15 ffaf32">哈哈哈哈</span><span id="sex" class="sex ">男士</span>:</p>
              <p class="f13 color666">您的跟单经纪人<span id="agent_name" class="name f13 ffaf32">(哈哈)</span>邀请您对<span id="brand">喜茶</span>
                <span id="ui_need">进行</span>
              </p>
            ...
            <div class="ui_middle_brand">
               ...
               <p class="f12 color999 margin05">考察场地<span id="name" class="storename f12 color666 fr">考察门店：杭州喜茶文化创意园</span></p>
               <p class="f12 color333"><span id="name" class="belongname f12 color666 fr">所在地区：杭州市人民政府</span></p>
               <div style="width:100%;height:0.5rem;clear:both"></div>
               <p class="f12 color333"><span id="name" class="detailname f12 color666 fr">地址：杭州市人民政府</span></p>
               <div style="width:100%;height:0.5rem;clear:both"></div>
               <p class="f12 color999">考察时间<span id="name" class="time_name f12 color666 fr">2017/12/25</span></p>
               <p class="f12 color999" style="margin:0 0 0rem">定金金额<span id="name" class="curreny_name f12 color666 fr">￥3000</span></p>
            </div>
            ...
            <div style="width:100%;height:6rem" class="clear"></div>
            <ul class="ui_fixed ">
              <li class="fe556b">拒绝</li>
              <li class="be74">接受考察邀请函</li>
            </ul>
             <div class="ui_fixeded none ff5a00">
                查看我的订单
            </div>
        <div>
    </section>
@stop
@section('endjs')
<script type="text/javascript" src="/js/_v020800/investask.js"></script>
<script>
  ...
  if(isiOS){
    if(window.screen.height==812){
      $('.ui_fixeded,.ui_fixed').css({'bottom':'17px'});
      $('.ui_top_fixed').css({'top':'3rem'});
      $('.ui-iphoneX').css({'height':'3.5rem','width':'100%'});
    }
  }
</script>
@stop