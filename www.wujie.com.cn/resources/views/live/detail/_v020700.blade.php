...
@section('main')
    ...
    <script type="text/javascript" src="{{URL::asset('/')}}/js/_v020700/live_020700.js?v=03162003"></script>
    <script> 
      ...
      function table(){
         ...
         $('#nav_eve_say').on('click',function(){
          ...
          $('#bind_activity').addClass('none');
          $('#bind_brand').addClass('none');
          $('#intro_live').addClass('none');
          $('#distribution').hide();
          $('#morebrand_detail').addClass('none');
          $('#comment_btn').show(); 
        })
         //详情
         $('#nav_de_').on('click',function(){
          ...
          $('#intro_live').removeClass('none');
          $('#morebrand_detail').removeClass('none'); 
        })
