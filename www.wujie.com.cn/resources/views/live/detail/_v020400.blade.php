...
@section('css')
    ...
    <link href="{{URL::asset('/')}}/css/act_detail.css?v=01120954" rel="stylesheet" type="text/css"/>
@stop
@section('main')
    <section class="containerBox" id="containerBox" style="visibility: hidden;">
        ...
        <!--直播分享-->
        <div class="share_video none" id="share_video" style="background-color: #000;">
        ...
        <!--直播倒计时-->
        <div class="live_time none" id="daojishi" style="background-color: #000;">
        ...
        <section class="videonews_box" id="videonews_box">
            <nav class="column TwoColumn none" id="columns">
...
@section('endjs')
    ...
    <script type="text/javascript" src="{{URL::asset('/')}}/js/collect.js?v=12242123"></script>
    <script type="text/javascript" src="{{URL::asset('/')}}/js/v0240/src/videodetail.js?v=01120954"></script>
