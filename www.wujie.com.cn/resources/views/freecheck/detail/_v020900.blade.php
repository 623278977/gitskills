  ...
  Zepto(function () {
	  ...
	  // 判断客户端
       ...
       //获取举办地城市
			  ...
			  function enroll(uid,activity_id,ticket_id,maker_id,cost,product,body,pay_way,name,tel,path,share_mark,code){
			  		var param={};
			  		param['uid']=uid;
			  		param['activity_id']=activity_id;
		...
		//个人信息完善
			...
			var Tang=$('.selected-flag').attr('title');
			var Tangson=Tang.indexOf('China')>=0?true:false;
			...
			$(document).on('tap','#enroll',function(){
				...
				enroll(0,activity_id,ticket_id,maker_id,0,product,body,'none',nickname,phonenum,'html5',sharemark,nation_code);
			});
