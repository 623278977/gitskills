...
@section('beforejs')
   ...
   if(!(isiOS||isAndroid)){
        window.location.href = labUser.path + 'webapp/brand/pc/_v020700?id='+id+'&uid='+uid+'&share_mark='+origin_mark+'&code='+origin_code+shareUrl;
   }
   </script>
@stop
@section('main')
    ...
    <section>
        ...
        <div class="brand-btns fixed width100 none brand-np  brand-s" id="brand_btns_app ">
           ...
           <div class="btn fl width33 pt05" id="get_coin">
                <p class="tc color8a f16">我要佣金</p>
                <p class="tc color-yellow f12">分享转发，邀请好友</p>
            </div>
