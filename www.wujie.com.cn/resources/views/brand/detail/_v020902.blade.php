...
@section('main')
        ...
        <div class="install-app install-app2 none" id="installapp">
            ...
            <section  class="pb8" id="swiper-1">
                ...
                <div class="brand-head white-bg mb1-5 " >
                    ...
                    <div class="join_type_box fline lh45" style="padding-left: 1.5rem;padding-right: 1.5rem;" id="join_type_box">
                       <div class="f14 color666 width33_3 l" id="pinpai">
                           <img src="/images/agent/dandian.png" alt="" class="join_type">
                           品牌加盟
                       </div> 
                       <!-- <div class="f14 color666 width33_3 l none" id="quyu">
                           <img src="/images/agent/quyu.png" alt="" class="join_type">
                            区域代理
                       </div>  -->
                       <div class="f14 color666 width33_3 l" id="qudao">
                           <img src="/images/agent/qudao.png" alt="" class="join_type">
                           渠道加盟
                       </div> 
                    </div>
                ...
                <div class=" mb1-5">
                    ...
                    <div class="lh45 tc white-bg">
                        <button class="border-ffa f14" id="toMoreDetail">更多详情</button>
                    </div>
                </div>  
                <!-- 第三部分,盈利预估 -->
                ...
                <!-- 第四部分 主打产品 -->
                <div class="white-bg mb1-5 " id="product">
                    <div class="lh45 fline ml1-33" >
                        <span class="tl f16 b">主打产品</span>
                    </div>
                    <div class="mt1 pr1-33 pl1-33">
                        <ul class="pic_list" id="product_imgs">
                                     
                        </ul>
                        <div class="clearfix"></div>               
                    </div>
                    <div class="f14" id="products_class">
                       <!-- <div class="fline lh45 b" style="padding-left: 1.33rem;">分类名称</div>
                       <ul class="color666 products lh45" id="products_name">
                            <li class="bline rline">产品名称</li>
                            <li class="bline  ">产品名称</li>
                            <li class="bline rline">产品名称</li>
                            <li class="bline ">产品名称</li>
                            <li class="bline rline">产品名称</li>
                        </ul> 
                ...
                <div class=" white-bg mb1-5" id="brand_question">
                    ...
                    <div class="tf tc lh45 ">
                            <button class='my-ques  f14 border-ffa '>我要提问</button>
                    </div>  
                </div>
                ...
                <div class=" white-bg mb1-5">
                   <div class="pl1-33  relative" id="brand_judge">
                        ...
                        <div class="tf fline tc lh45 ">
                            <button class='toAlljudge  f14 border-ffa'>查看全部评价</button>
                        </div> 
                    </div>
                </div>
                <!-- 分享出去才会出现的品牌推荐 -->
    ...
    <section id="bottom_public">
        ...
        <!-- 咨询类型 -->
        <!-- <div class="pl1-5 pr1-5 pt2 pb3 b-radius03 consult_type none" id="consult_type">
            <p class=" f20 tc b pb3">你最想咨询的...</p>
            <p class="f15">
                为了让无界商圈客服人员更好的了解您的需求大方向，请选择以下选框。
            </p>
            <p class="f10 color999">
                想要单店加盟，还是承包整个鱼塘，客户会为你准备精准的加盟方案，让你实惠满满！
            </p>
            <ul class="schemes">
                <li id="dandian_sch" class="choosen">想了解单店加盟方案，获取更多优惠政策</li>
                <li id="quyu_sch">想了解区域代理，获得更多渠道信息</li>
                <li id="pinpai_sch">想了解品牌代理业务，获得更多渠道信息</li>
                <li id="qudao_sch"> 想了解渠道代理业务，获得相应合作信息</li>
                <li>没有特别明确，心很大，都想了解一下</li>
            </ul>
            <div class="flex-bet pt1">
                <button class="bet_button color999 border-ddd" id="wait_more">想想再说</button>
                <button class="bet_button white bcf5a" id="confirm_consul">确认咨询</button>
            </div>
        </div> -->
        <!-- 公用-蒙层 -->
...
@section('endjs')
	...
	<script src="{{URL::asset('/')}}/js/_v020902/brand.js"></script>
@stop