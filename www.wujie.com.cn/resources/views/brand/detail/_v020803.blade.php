            ...
            <div  id="swiper-container1">
                <div class="swiper-wrapper" id="wrapper1">
                    ...
                    <section  class="swiper-slide pb8" id="swiper-1">
                        ...
                        <!-- 第二部分，基本信息 -->
                        <div class="brand-info mb1-5   ">
                            <div class="brand-pl  white-bg">
                                <div class="info ">
                        ...
                        <div class="brand-info white-bg mb1-5" id="brand_tag_none">
                         ...
                         <div class="brand-concern pb1 pt1 bgwhite mb1-33 mt1-33 relative" id="brand_asks"> 
                                <a href="javascript:;" class=" blocks l ml3-5 f14 seeks  brand-share-ask" data-type="discount">询问加盟方案</a>
                                <a href="javascript:;" class=" blocks r f14  mr3-5 seeks brand-share-ask" data-type="floor_price">了解加盟优惠</a>
                                <div class="clearfix">  </div>
                        </div>
...
@section('endjs')
   ...
   <!--  <script src="{{URL::asset('/')}}/js/dist/finger-mover.min.js"></script> -->
	...
	<script src="{{URL::asset('/')}}/js/_v020800/brand_03.js"></script>
    <script>  
