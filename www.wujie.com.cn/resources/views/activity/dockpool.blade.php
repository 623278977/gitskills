...
@section('css')
<link rel="stylesheet" href="//g.alicdn.com/de/prismplayer/1.4.8/skins/default/index-min.css" />
@stop
@section('main')
	<!--
	<section id="dockpoolSection" class="none">
		<div class="bgcolor">
...
@section('endjs')
	<script type="text/javascript" src="//g.alicdn.com/de/prismplayer/1.4.8/prism-min.js"></script>
	<script>
		// 初始化播放器
		var player = new prismplayer({
			id: "J_prismPlayer", // 容器id
			source: "http://zhibo.tyrbl.com/wjsq/StreamName_hd.flv",// 视频地址
		...
		Zepto(function () {
			...
			var dockPool = {
				getList: function (param) {
					var url = labUser.api_path + '/userapply/index';
				...
				sendRemind: function (param, obj) {
					var url = labUser.api_path + '/userapply/remindreply';
					ajaxRequest(param, url, function (data) {
						if (data.status) {
