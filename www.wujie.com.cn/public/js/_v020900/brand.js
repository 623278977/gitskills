...
//提交意向加盟时获取用户详情
            ...
            ajaxRequest(param, url, function(data) {
                if (data.status) {
                    ...
                    $('#product_imgs li').click(function(){
                        ...
                        viewBigpic('product',data.message.brand.detail_images,index);
                    });
    ...
    //评价
       if(comment){
            ...
            judgeHtml += '<div class="tf fline tc lh45 "><button class="toAlljudge btn-detail">查看全部评价</button></div>';
...
function showShare() {
    ...
    var pageUrl =labUser.path+ 'webapp/brand/detail/_v020900?id=' + id + '&uid=' + uid;
