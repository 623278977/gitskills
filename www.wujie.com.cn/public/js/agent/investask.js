Zepto(function (){
    ...
    // if(obj.length>0){
      // $.each(obj,function(k,v){
        ...
        var html='';
            ...
            html+='<section class="ui_invite_container" data-id="'+t.inspect_id+'" style="height:27rem">';
            html+=' <div class="ui_infor">\
             ...
             html+='<img class="fl martop"  src="/images/020700/gg.png" alt="">';
              ...
              html+='</section><div class="ui_send_again" data-uid="'+t.uid+'" data-id="'+t.inspect_id+'" data-title="'+t.brand_name+'" data-imgUrl="'+t.brand_logo+'" data-date="'+t.inspect_time+'" data-store="'+t.store_name+'"data-nickname="'+t.nickname+'">再次发送</div>';
                  ...
                  if(obj){
                    $.each(obj,function(i,t){
                         var html='';
                             ...
                             html+='<section class="ui_invite_container"  data-id="'+t.inspect_id+'" style="height:29.55rem">';
                             html+=' <div class="ui_infor">\
                                       <ul class="ui_infor_tab">\
                                         <li class="f12 color333">邀请人</li>';
                             html+='<li><p class=" f12 b margin05">'+t.nickname+'</p><p class="f12 margin05">'+(t.brand_name.length>15?t.brand_name.substr(0,13)+'…':t.brand_name)+'·意向投资人</p></li>';
            ...
            if (data.status) {
               // $.each(data.message,function(k,v){
                ...
                var html='';
                    ...
                    html+='<section class="ui_invite_container"  data-id="'+t.inspect_id+'" style="height:30.1rem">';
                    html+=' <div class="ui_infor">\
                                     <ul class="ui_infor_tab">\
                                       <li class="f12 color333">邀请人</li>';
                    html+='<li><p class=" f12 b margin05">'+t.nickname+'</p><p class="f12 margin05">'+(t.brand_name.length>15?t.brand_name.substr(0,13)+'…':t.brand_name)+'·意向投资人</p></li>';
   ...
   // 再次发送考察邀请函
    ...
    $(document).on('click','.ui_invite_container',function(){
      var ID=$(this).data('id');  
      window.location.href = labUser.path + "webapp/agent/newsinvestask/detail?inspect_id="+ID;
    })
});//zepto外层
