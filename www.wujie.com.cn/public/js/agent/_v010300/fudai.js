...
Zepto(function(){
   ...
   var Fudai={
           ...
           data:function(obj){
                    ...
                    $('footer').html('<a  href="tel:4000110061" style="color:#2873ff">联系我们</a>');
           },
           stamp:function(unix){
           ...
           investor:function(obj){
                   if(obj){
                    ...
                    $('.ui-size3').attr('src',(obj.user_logo?obj.user_logo:'/images/default/avator-m.png'));
                    $('.red-pocket-detail li').eq(1).find('p').eq(0).html('<span class="color333 f15">'+(obj.user_name.length<5?obj.user_name:obj.user_name.substr(0,5)+'…')+'</span>('+obj.user_tel+')');
