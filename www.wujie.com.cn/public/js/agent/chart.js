...
;(function ($, window, document) {
    ...
    radialIndicator.defaults = {
        ...
        barBgColor: '#ffa300', //unfilled bar color
        barColor: '#ccc', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
