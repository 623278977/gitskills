    ...
    var Detail = {
        ...
        brand:function(obj){
            if(obj.title.length>3){
                ...
                $('#ui_brand').text(obj.title.substring(0,2)).addClass('none');
                $('#boss_wanted').text(obj.title.substring(0,2)+'…'+'意向投资人');
                $('#agentself_wanted').text(obj.title.substring(0,2)+'…'+'代理经纪人');
            }else{
                $('.ui_brandname').text(obj.title);
                $('#ui_brand').text(obj.title).addClass('none');
