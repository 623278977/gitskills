...
Zepto(function (){
    ...
    if(obj.length>0){
      $.each(obj,function(k,v){
        var html='';
            ...
            html+='<section class="ui_invite_container" ><div class="ui_infor zone" data-id="'+v.id+'"><ul class="ui_infor_tab">';
            ...
            html+='<ul class="ui_address zone" data-id="'+v.id+'">\
            ...
            if(v.activity_title.length>10){
              html+='<p class="ui_address_detail b f14">'+v.activity_title.substring(0,10)+'…'+'</p>';
             }else{
           ...
           if(v.cities.length>14){
            ...
            html+='<ul class="ui_status zone" data-id="'+v.id+'">\
            ...
            html+='<div style="width:100%;height:1.5rem;clear:both"></div>\
                    <ul class="accept_refuse clear">\
                        <li class="ui_upordown" data-id="'+v.id+'"><a class="ui_border ui_refuse f13 color666 ">关闭</a></li>\
                        <li class="ui_send_again" data-id="'+v.id+'"  data-title="'+v.activity_title+'" data-uid="'+v.uid+'" data-imgurl="'+v.activity_list_img+'"  data-nickname="'+v.nickname+'"><a class="f13 ui_accept clear ">再次发送</a></li>\
                     </ul>';
            html+='</section>';
            // html+='<div class="ui_send_again" data-id="'+v.id+'"  data-title="'+v.activity_title+'" data-uid="'+v.uid+'" data-imgurl="'+v.activity_list_img+'"  data-nickname="'+v.nickname+'">再次发送</div>';
              ...
              if(data.message.length>0){
               $.each(data.message,function(k,v){
                 var html='';
                     ...
                     html+='<section class="ui_invite_container zone" style="height:21.8rem" data-id="'+v.id+'">\
                             <div class="ui_infor">\
            ...
            if (data.status) {
               ...
               $.each(data.message,function(k,v){
                var html='';
                    ...
                    html+='<section class="ui_invite_container zone" style="height:25rem" data-id="'+v.id+'">\
                             <div class="ui_infor">\
                               <ul class="ui_infor_tab">\
                                 <li class="f12 color333">受邀人</li>\
                                  <li>\
    ...
    $(document).on('click','.zone',function(){
          var id=$(this).data('id');
         window.location.href = labUser.path + "webapp/agent/newsactask/detail/_v010002?invite_id="+id;
      })
        //当最后一个没有的时候调用，出现缺省图;
    function experience(){
