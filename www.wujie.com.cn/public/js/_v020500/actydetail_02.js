        ...
        if (is_share) {
            ...
            if (timestamp < end_time) {
                ...
                var endBtn = '<div class="fixed_btn" id="notzbBtn">' ;
                    if(is_praise==1){
                        endBtn+='<button class="actzan width20 yizan" disabled></button>';
                    }else{
                        endBtn+='<button class="actzan width20 weizan" ></button>';
                    };
                    endBtn+= '<button class="chat width20"></button>' +
                    '<button class="zhuan width20"></button>' +
                    '<button class="signup width40 ccc" disabled>无法报名</button>' +
                    '</div>';
