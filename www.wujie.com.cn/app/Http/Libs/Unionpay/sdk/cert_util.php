<?php
namespace App\Http\Libs\Unionpay\sdk;
...
//		if (SDKConfig::getSDKConfig()->middleCertPath === null || SDKConfig::getSDKConfig()->rootCertPath === null){
		if (config('unionpay.unionpay.acpsdk_middleCert_path') === null || config('unionpay.unionpay.acpsdk_rootCert_path') === null){
...
// array(SDKConfig::getSDKConfig()->rootCertPath, SDKConfig::getSDKConfig()->middleCertPath));
		$result = openssl_x509_checkpurpose($certBase64String, X509_PURPOSE_ANY,
            array(config('unionpay.unionpay.acpsdk_rootCert_path'), config('unionpay.unionpay.acpsdk_middleCert_path')));
		if($result === FALSE){
