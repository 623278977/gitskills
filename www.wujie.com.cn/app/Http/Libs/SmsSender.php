...
class SmsSenderUtil {
    ...
    protected  $appid = 1400028387;//1251768344
    protected  $appkey = "33fc2a0861052ff6f09f6a2f5d845ab5";
...
class SmsSingleSender {
     ...
     */
    function send($smsType,$phoneNumber, $msg, $nationCode = '86', $extend = "", $ext = "") {
/*
请求包体
{
    "tel": {
...
*/
//        $nationCode = '86';
        if (strpos($msg, '验证码') !== false && strpos($msg, '分钟内') !== false) {
            $type = 0;//0 为普通短信，1 营销短信
        }else {
            if (strpos($msg, 'http://') !== false && $smsType == 'live_share_subscribe') {
                $msg = str_replace('【无界商圈】', '', $msg) . '回T退订';
                $type = 1;
            }elseif($smsType == 'agent_register_success_info'){
                $type = 1;
            }else{
                $type = 0;
            }
