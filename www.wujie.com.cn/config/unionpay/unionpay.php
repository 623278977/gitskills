...
//'acpsdk.backUrl'=>'http://222.222.222.222:8080/upacp_demo_app/demo/api_05_app/BackReceive.php',


'acpsdk_backUrl'=>'http://'.env('APP_HOST').'/api/order/unionpaynotify',
...
//; windows样例：
'acpsdk_signCert_path'=>config_path('unionpay').'/acp_test_sign.pfx',
//'acpsdk_signCert_path'=>config_path('unionpay').'/tyrbl_sign.pfx',
...
'acpsdk_signCert_pwd'=>'000000',

//;;;;;;;;;;;;;;;;;;;;;;;;;;加密证书配置;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
//; 敏感信息加密证书路径(商户号开通了商户对敏感信息加密的权限，需要对 卡号accNo，pin和phoneNo，cvn2，expired加密（如果这些上送的话），对敏感信息加密使用)
'acpsdk_encryptCert_path'=>config_path('unionpay').'/acp_test_enc.cer',

//;;;;;;;;;;;;;;;;;;;;;;;;;;验签证书配置;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
//; 验签中级证书（证书位于assets/测试环境证书/文件夹下，请复制到d:/certs文件夹）
'acpsdk_middleCert_path'=>config_path('unionpay').'/acp_test_middle.cer',
//; 验签根证书（证书位于assets/测试环境证书/文件夹下，请复制到d:/certs文件夹）
'acpsdk_rootCert_path'=>config_path('unionpay').'/acp_test_root.cer',
